...
with ty_val_p : ctx -> val -> typ -> Prop :=
...
with   rules_val_mut    := Induction for ty_val_p Sort Prop
...
Combined Scheme rules_mutind from rules_trm_mut, rules_val_mut, rules_def_mut, rules_defs_mut, rules_subtyp.
...
Ltac fresh_constructor :=
  match goal with
  | [ |- _ ⊢!v val_new _ _ : typ_bnd _ ] =>
    apply_fresh ty_new_intro_p as z
  | [ |- _ ⊢!v val_lambda _ _ : typ_all _ _ ] =>
