...
(* ************************************************************************** *)
(** * Updating the Heap *)
(** [defs_update hds a x hds'] represents updating a field of label [a] in the
heap definitions [hds] with the reference [x] with the resulting heap
definitions being [hds'] *)
...
(** [heap_update Sigma x a y Sigma'] represets what happens when a write [x.a := y] succeeds.
The field [a] of the object represented by [x] is updated with the reference [y]. *)
...
(** ** Simple Lemmas about updating heap defs *)
