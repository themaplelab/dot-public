...
Require Import Initialization InitLookup InitLookupLemmas VarsSubst InitVarSubtyping
        InitTyping InitTypingLemmas
        InitWeakening.
...
(** * Renaming Lemmas for Initialization *)
...
Proof.
  ...
  rewrite subst_single.
  assert (x <> x') as Hxx'.
  { intro; subst. apply init_var_typing_implies_bound in Hinit.
...
Proof.
  ...
  - apply init_var_weaken_vars.
    ...
    + apply init_var_typing_implies_bound in H8; destruct H8.
