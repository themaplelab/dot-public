...
Require Import
        ...
        Substitution RenameConstructors
...
Require Import Effects InitLookup InitLookupLemmas InitTyping InitTypingLemmas InitWeakening
...
Require Import FreeItems FreeItemLemmas HeapItemUpdateLemmas FreeSubHeapSingleLemmas FreeSubHeapStackLemmas.

Implicit Types (Gamma : ctx) (Delta : init_ctx) (Sigma : heap) (ℰ : eff_ctx).

(** * Progress Lemma Cases *)
(** The different cases for the progress lemma require different amounts of
    bookkeeping, so we split each case into a different lemma. *)

(** *** Progress when the focus of execution is a variable *)
...
(** *** Progress for constructor calls *)
