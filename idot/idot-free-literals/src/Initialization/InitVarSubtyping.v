...
Proof.
  ...
  intros vs Hiv.
  inversions Hiv; binds_eq; inversions Hisub; eauto using vars_subst_in1.
Qed.
...
Proof.
  ...
  - apply init_var_free_unspec; auto using vars_subst_in.
    cases_if; eauto using binds_middle_neq_binds.
    apply Hibsub in H0. destruct H0 as [?i [His Hbiy]]; inversions His; auto.
  - cases_if.
    + apply Hibsub in H0. destruct H0 as [?i [His Hbiy]]; inversions His; auto.
