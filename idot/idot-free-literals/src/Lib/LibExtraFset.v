...
From TLC Require Import LibFset LibLN.
...
Lemma remove_notin_inv : forall A (vs : fset A) (v x : A),
    v \in vs -> v \notin vs \- \{x} -> v = x.
Proof with eauto.
  intros. hnf in H0. rewrite in_remove in H0.
  destruct (classicT (v = x))...
  exfalso. eapply H0. split... rewrite notin_singleton...
Qed.
